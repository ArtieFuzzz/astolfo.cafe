<div class="w-[60vw] flex flex-col justify-center items-center h-screen">
  <div class="m-20">
    ...
    <p>
      This website uses Cloudflare, visit their <a href="https://www.cloudflare.com/privacypolicy/"
        >Privacy Policy</a
      >
    </p>
    ...
    <p>
      ...
      purposes, using a self-hosted instance @ analytics.uvvu.pw. We do not track you in any way nor
